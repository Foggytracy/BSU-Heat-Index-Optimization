% =========================================================
%  Heat Index Time Series Analysis - Results & Visualization
%  Bulacan State University - Math Modeling Paper
%  BSM CS 3B | Prof. Aarhus M. Dela Cruz
% =========================================================

clc; clear; close all;

% ----------------------------------------------------------
% RAW HISTORICAL DATA (from Math_Modeling_Dataset.xlsx)
% Monthly average Heat Index, Jan 2023 - Mar 2026
% ----------------------------------------------------------
HI_historical = [
...
month_nums = [1:12, 1:12, 1:12, 1:3];  % month number for each observation
...
% Running minimum for convergence
num_windows = n - L + 1;
